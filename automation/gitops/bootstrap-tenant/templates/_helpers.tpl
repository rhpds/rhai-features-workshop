{{/*
Repo path for a deployment chart, honouring bootstrap.pathPrefix so this tree
can live at gitops/ (fed-aura-capital) or automation/gitops/ (rhai-features-workshop).
